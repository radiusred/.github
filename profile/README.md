...
Radius Red Ltd. is a UK-based engineering company.
...
- [`tradedesk-miner`](https://github.com/radiusred/tradedesk-miner)  
  Agent-operable data-mining engine for historical OHLCV data that scans cached candle files and surfaces statistical anomalies, cross-instrument relationships, and seasonality effects.
...
Our public repositories are developed to be usable outside the company as well as inside it:

- permissive licensing
- repository-local documentation
- reviewable, incremental change sets
- practical tooling over marketing copy

## Contributions

Contributions are accepted on a per-project basis.  
Please refer to the repository README and `CONTRIBUTING.md` file where present for current guidance.
